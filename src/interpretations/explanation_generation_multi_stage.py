...
semantic_features, temporal_change, and possible_reason_for_saliency.
...
- Explanation should not be generic such as "high contrast motion blur with temporal persistence". 
...
{{
  ...
  "candidate_name": "...",
  "pattern_type": "low-level | semantic | temporal | mixed | unclear",
  "common_pattern": "...",
  "temporal_behavior": "...",
        ...
        record.update(
            {
                ...
                "temporal_change": str(parsed_llm.get("temporal_change", "unclear")),
        ...
        summaries.append(
            {
                ...
                "temporal_change": record.get("temporal_change", "unclear"),
        ...
        record.update(
            {
                ...
                "temporal_behavior": str(parsed_aggregate.get("temporal_behavior", "unclear")),
